// History page data and configuration for WEB environment
...
// Web environment specific history data
export const WEB_HISTORY_DATA = {
  // Sample data for web deployment
  SAMPLE_TICKETS: [
    {
      key: 'PB-5678',
      summary: 'Sample Bug Report - Web Environment',
