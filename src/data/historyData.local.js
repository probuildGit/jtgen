// History page data and configuration for LOCAL environment
...
// Local environment specific history data
export const LOCAL_HISTORY_DATA = {
  // Sample data for local development
  SAMPLE_TICKETS: [
    {
      key: 'PB-1234',
      summary: 'Sample Bug Report - Local Environment',
